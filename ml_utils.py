...
def read_and_extract_features(reader):
    ...
    # print('read_and_extract_features')
    # print("ret: ", X)
    # print("len(ret): ", len(X))
    return (X, ret['y'])
...
def extract_features_from_rawdata(chunk, header):
    ...
    # print("extract_features_from_rawdata")
    # print("data: ", data)
    # print("len.data: ", len(data))
...
def extract_features_single_episode(data_raw):
    ...
    # print('extract_features_single_episode')
...
def calculate(channel_data, period, sub_period, functions):
    ...
    data = [x for (t, x) in channel_data
            if L - 1e-6 < t < R + 1e-6]
    # print("channel_data: ", len(data))
    if len(data) == 0:
        return np.full((len(functions, )), np.nan)
    # print('calculate')
    # print("calculate: ", data)
    # print("len.calculate: ", len(data))
